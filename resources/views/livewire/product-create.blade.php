<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
                    Buat Produk Baru
                </h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Tambahkan produk baru ke katalog Anda dengan informasi lengkap dan tingkat harga.</p>
            </div>
        ...
        <!-- Form Card -->
        <form wire:submit.prevent="store" class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <!-- Header Section -->
            <div class="px-8 py-8 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">📋 Informasi Dasar Produk</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Isi detail utama dari produk Anda</p>
            </div>
            ...
            <div class="px-8 py-8 space-y-8">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6">
                        @if($image)
                            <div class="shrink-0 w-24 h-24 rounded-xl overflow-hidden border-2 border-indigo-300 dark:border-indigo-600 bg-gray-100 dark:bg-gray-700 shadow-md">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition" placeholder="contoh: Indomie Goreng">
                        @error('name') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Kategori *</label>
                        <select wire:model="category_id" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="sku" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition" placeholder="SKU123">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="barcode" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition" placeholder="123456789">
                    ...
                    <div>
                        ...
                        <select wire:model="base_unit_id" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="description" class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 dark:focus:ring-offset-gray-800 px-4 py-3 transition" placeholder="Deskripsi singkat produk">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 px-8 py-8 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-800/30">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Atur berbagai tingkat harga untuk unit berbeda</p>
                    </div>
                    <button type="button" wire:click="addProductUnit" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition shadow-sm">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition relative shadow-sm">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" wire:model="productUnits.{{ $index }}.conversion" class="w-full text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white py-2 px-3 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 transition" placeholder="cth: 1.0 atau 24.0">
            ...
            <div class="px-8 py-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3 rounded-b-3xl">
                ...
                <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 border border-transparent rounded-lg hover:from-indigo-700 hover:to-purple-700 transition shadow-md">
                    ✨ Buat Produk
                </button>
            </div>
        </form>
