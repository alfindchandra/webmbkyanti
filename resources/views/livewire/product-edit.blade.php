                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition relative shadow-sm">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" wire:model="productUnits.{{ $index }}.min_qty" class="w-full text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white py-2 px-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition" placeholder="1.0">
